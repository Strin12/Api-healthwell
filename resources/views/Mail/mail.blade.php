...
<tr>
 <td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; margin: 0;" align="left">
<img class="" width="100" height="100" src="http://imgfz.com/i/mAw9Did.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
</td>
</tr>
 </tbody>
</table>

 <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Bienvenido a HealthWell</h4>
...
<td style="border-top-width: 0; border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-color: #e9ecef; border-top-style: solid; margin: 0; padding: 12px;" class="text-right" align="right" valign="top">{{ $user->email }} </td>
 ...
 <img width="556" height="322" class="img-fluid" src="http://imgfz.com/i/DGds78P.jpeg" style="height: auto; line-height: 100%; outline: none; text-decoration: none; width: 100%; max-width: 100%; border: 0 none;">
</div>
 </td>
</tr>
 </tbody>
...
<img width="50" height="50" class="" src="https://img.icons8.com/color/48/000000/info--v1.png" style="height: auto; line-height: 100%; outline: none; text-decoration: none; border: 0 none;">
 ...
 <h4 class="text-center" style="margin-top: 0; margin-bottom: 0; font-weight: 500; color: inherit; vertical-align: baseline; font-size: 24px; line-height: 28.8px;" align="center">Para acceder a la aplicación</h4>
...
 
 ...
 <div class="text-center text-muted" style="color: #636c72;" align="center">Somos una empresa orgullosamente Méxicana</div>
 <div class="text-center text-muted" style="color: #636c72;" align="center">formada por un equipo de trabajo enfocado en</div>
 <div class="text-center text-muted " style="color: #636c72;" align="center">la realizacion de aplicaciones web y moviles.</div>
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
 <tbody>
<tr>
 <td height="24" style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 24px; width: 100%; height: 24px; margin: 0;" align="left">
...
<tbody>
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Cel.271-116-08-25 </td>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">
 ...
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Correo: healthwellapp@gmail.com</td>
 </tr>
 <tr>
<td style="border-spacing: 0px; border-collapse: collapse; line-height: 24px; font-size: 16px; border-top-width: 0; border-bottom-width: 0; margin: 0;" align="left">Facebook: HealthWellApp</td>
 </tr>
</tbody>
 </table>
<table class="s-4 w-100" border="0" cellpadding="0" cellspacing="0" style="width: 100%;">
